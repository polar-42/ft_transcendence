...
ganache --database.dbPath /var/blockchain/state/ --wallet.accounts "0x$PRIVATE_KEY, 1000000000000000000000" --chain.chainId "31337" --server.port "8545" --server.host "$(hostname -i)"

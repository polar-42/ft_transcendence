...
export class TrailRenderer extends THREE.Object3D {
    ...
    zeroVertices () {
        ...
        positions.addUpdateRange.count = - 1;
    }
    ...
    zeroIndices () {
        ...
        indices.addUpdateRange.count = - 1;
    }
    ...
    updateNodeID (nodeIndex, id) { 
        ...
        nodeIDs.addUpdateRange.offset = nodeIndex * this.VerticesPerNode; 
        nodeIDs.addUpdateRange.count = this.VerticesPerNode;
        nodeVertexIDs.addUpdateRange.offset = nodeIndex * this.VerticesPerNode;
        nodeVertexIDs.addUpdateRange.count = this.VerticesPerNode;
    }
    ...
    updateNodeCenter (nodeIndex, nodeCenter) { 
        ...
        nodeCenters.addUpdateRange.offset = nodeIndex * this.VerticesPerNode * TrailRenderer.PositionComponentCount; 
        nodeCenters.addUpdateRange.count = this.VerticesPerNode * TrailRenderer.PositionComponentCount; 
    }
    ...
    updateNodePositionsFromTransformMatrix = function() { 
        ...
        return function updateNodePositionsFromTransformMatrix(nodeIndex, transformMatrix) {
            ...
            positions.needsUpdate = true;
            positions.addUpdateRange.offset = nodeIndex * this.VerticesPerNode * TrailRenderer.PositionComponentCount; 
            positions.addUpdateRange.count = this.VerticesPerNode * TrailRenderer.PositionComponentCount; 
        };
